...
import { slotDelete } from "../../api/adventureApi";
...
function Booking() {
  ...
  //     await slotDelete(slotId,Id);
  //     GenerateSuccess(slotDelete.message)
  //     queryClient.invalidateQueries('adventure');
  //   } catch (error) {
  //     GenerateError(slotDelete.message)
  ...
  const handleDelete = async (slotId, Id) => {
    try {
      ...
      GenerateError("Error deleting slot");
      console.error("Error deleting slot:", error);
    }
  };
      ...
      <div className="container mx-auto">
        <div className="m-3 flex items-center justify-between gap-8 bg-[#588157] rounded-md p-3">
          <div>
            ...
            <Typography
              color="gray"
              className="mt-1 font-normal text-[#344E41]"
            >
