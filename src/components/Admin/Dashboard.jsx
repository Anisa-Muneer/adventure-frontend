...
import { adminDashboardData } from '../../api/adminApi';
          ...
          data: [
            {
              ...
              avgTemp: 2.3,
              Bookings: response.data.newYearTotalSales,
            },
            {
              year: moment(response.data.startDate).format("MMM"),
              avgTemp: 6.3,
              Bookings: response.data.secondYearTotalSales,
            },
            {
              year: moment(response.data.thirdDate).format("MMM"),
              avgTemp: 16.2,
              Bookings: response.data.thirdYearTotalSales,
            },
          ],
        }));
      }
      ...
      <div className="p-4  h-screen  dark:border-gray-700 mt-14">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
          <div className=" flex  items-center gap-4 shadow-lg h-24 rounded bg-gray-50 dark:bg-gray-800">
            <div className="w-1/3 h-full flex items-center rounded-l justify-center bg-blue-gray-100">
              <svg
            ...
            <div>
              <h1 className="font-bold text-lg text-gray-600">
                {dashboardData && dashboardData.userLength}
              </h1>
          ...
          <div className="flex items-center gap-4 shadow-lg h-24 rounded bg-gray-50 dark:bg-gray-800">
            ...
            <div>
              <h1 className="font-bold text-lg text-gray-600">
                {dashboardData && dashboardData.advLength}
              </h1>
              <h1 className="uppercase font-bold mt-2 text-gray-800">
                total adventure team
              </h1>
            </div>
          </div>
          <div className="flex items-center gap-4 shadow-lg h-24 rounded bg-gray-50 dark:bg-gray-800">
